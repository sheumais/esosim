...
pub static FLAME_WEAKNESS: Buff = Buff { id: FLAME_WEAKNESS_ID, value: 5, value_per_stack: 0};

pub const FROST_WEAKNESS_ID: u32 = 142652;
pub static FROST_WEAKNESS: Buff = Buff { id: FROST_WEAKNESS_ID, value: 5, value_per_stack: 0};

pub const SHOCK_WEAKNESS_ID: u32 = 142653;
pub static SHOCK_WEAKNESS: Buff = Buff { id: SHOCK_WEAKNESS_ID, value: 5, value_per_stack: 0};

pub const HARPOONERS_WADING_KILT_ID: u32 = 155150;
pub static HARPOONERS_WADING_KILT: Buff = Buff { id: HARPOONERS_WADING_KILT_ID, value: 0, value_per_stack: 2};

pub const SUL_XAN_SOULBOUND: u32 = 154737;
pub static SUL_XANS_TORMENT: Buff = Buff { id: SUL_XAN_SOULBOUND, value: 12, value_per_stack: 0};

pub const DEXTERITY_ID: u32 = 45564;
/// Only shows up for the person logging
pub static DEXTERITY: Buff = Buff { id: DEXTERITY_ID, value: 0, value_per_stack: 2};

pub const FELINE_AMBUSH_ID: u32 = 45301;
pub static FELINE_AMBUSH: Buff = Buff { id: FELINE_AMBUSH_ID, value: 12, value_per_stack: 0};

pub const HEMORRHAGE_PASSIVE_ID: u32 = 45060;
pub static HEMORRHAGE_PASSIVE: Buff = Buff { id: HEMORRHAGE_PASSIVE_ID, value: 10, value_per_stack: 0};
...
pub static FATED_FORTUNE: Buff = Buff { id: FATED_FORTUNE_ID, value: 12, value_per_stack: 0};

pub const LUCENT_ECHOES_ID: u32 = 220015;
pub static LUCENT_ECHOES: Buff = Buff { id: LUCENT_ECHOES_ID, value: 11, value_per_stack: 0};

pub const MORA_SCRIBES_THESIS_ID: u32 = 220315;
pub static MORA_SCRIBES_THESIS: Buff = Buff { id: MORA_SCRIBES_THESIS_ID, value: 0, value_per_stack: 1};
