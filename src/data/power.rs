...
pub static COURAGE_MINOR: Buff = Buff { id: COURAGE_MINOR_ID, value: 215f64, value_per_stack: 0f64 };
pub static COURAGE_MAJOR: Buff = Buff { id: COURAGE_MAJOR_ID, value: 430f64, value_per_stack: 0f64 };

pub static RUINATION: Buff = Buff { id: 45272, value: 258f64, value_per_stack: 0f64};
pub static ELEMENTAL_TALENT: Buff = Buff { id: 45276, value: 258f64, value_per_stack: 0f64};
pub static SWIFT_WARRIOR: Buff = Buff { id: 45312, value: 258f64, value_per_stack: 0f64};
pub static SUNDERER: Buff = Buff { id: 215727, value: 100f64, value_per_stack: 0f64};
pub static BERSERKER_INFUSED: Buff = Buff { id: 21230, value: 452f64, value_per_stack: 0f64};
pub static POWERFUL_ASSAULT: Buff = Buff { id: 61771, value: 307f64, value_per_stack: 0f64};
pub static AURA_OF_PRIDE: Buff = Buff { id: 163401, value: 260f64, value_per_stack: 0f64};
pub static PEARLESCENT_WARD: Buff = Buff { id: 172621, value: 180f64, value_per_stack: 0f64}; // should scale based on group members alive; also should be given when wearing PW set because it doesn't show up on logs for the person wearing the set
// pub static CORAL_RIPTIDE
// pub static GLYPHIC: Buff = Buff {}; // scales in proportion to health, todo
pub static SEETHING_FURY: Buff = Buff { id: 122729, value: 0f64, value_per_stack: 100f64};
